...
(function() {
    ...
    const APP_DATA = {
        motivationalMessages: [
            "Respect++ ðŸ’¯",
            "Brahmachari Mode Activated ðŸ§˜",
            "Strong mind, strong body! ðŸ’ª",
            "You're on fire! ðŸ”¥", 
            "Legend in the making! â­",
            "Stay strong, warrior! âš”ï¸",
            "Mind over matter! ðŸ§ ",
            "You got this! ðŸ’¯",
            "Discipline = Freedom! ðŸ—½",
            "Level up activated! ðŸš€",
            "Monk mode engaged! ðŸ´",
            "Self-control mastered! ðŸŽ¯"
        ],
        relapseMessage: "Oops... Nut busted ðŸ’¥ Back to Day 0",
        avatarLevels: [
            { minDay: 0, maxDay: 6, name: "Clown", emoji: "ðŸ¤¡", title: "Just Starting", description: "Everyone starts somewhere!" },
            { minDay: 7, maxDay: 29, name: "Rookie Monk", emoji: "ðŸ§˜", title: "One Week Strong", description: "You've made it through the first week!" },
            { minDay: 30, maxDay: 59, name: "Brahmachari Level", emoji: "ðŸ¥‹", title: "One Month Warrior", description: "30 days of discipline - impressive!" },
            { minDay: 60, maxDay: 999, name: "NutKhat Legend", emoji: "ðŸ‘‘", title: "Ultimate Champion", description: "You are a legend among legends!" }
        ],
    ...
    function checkForMilestone(previousStreak) {
        ...
        if (currentMilestone) {
            ...
            setTimeout(() => {
                showCelebration(
                    `ðŸŽ‰ ${currentMilestone} Days Milestone! ðŸŽ‰`,
    ...
    function handleCheckin() {
        ...
        if (!canCheckinToday()) {
            showMessage("You've already checked in today! Come back tomorrow! ðŸ˜Š");
            return;
        }
    ...
    function handleRelapse() {
        ...
        // Confirm relapse
        const confirmed = confirm("Are you sure you want to reset your streak? This cannot be undone! ðŸ˜”");
        if (!confirmed) {
    ...
    function initApp() {
        ...
        if (!localStorage.getItem('nutKhatData')) {
            setTimeout(() => {
                showMessage("Welcome to NutKhat! Start your journey today! ðŸš€", 4000);
            }, 1500);
        }
    ...
    log('ðŸ¥œ NutKhat v1.0.0 - Stay strong! ðŸ’ª');
    log('Master your mind, master your life! ðŸ§˜');
